...
# Klasör yolları
all_images_folder = "NLM_Acne"  # Tüm görsellerin bulunduğu klasör
exclude_images_folder = "acne_openi_elenecekler"  # Gereksiz görsellerin bulunduğu klasör
final_images_folder = "final_NLM_Acne"  # Sonuç klasörü
